...
class MinhasReservasNovaScreen extends StatefulWidget {
  const MinhasReservasNovaScreen({super.key});

  @override
  State<MinhasReservasNovaScreen> createState() => _MinhasReservasNovaScreenState();
}

class _MinhasReservasNovaScreenState extends State<MinhasReservasNovaScreen> {
